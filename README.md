...
Henüz silah veya araç kontrolü yok. Modun yüklendiğini Mods menüsünden veya log’daki `[UCV]` satırlarından doğrulayın.
...
- Silah, mermi, araç, GUI ve asset’ler henüz yok (Phase 2+).
